...
this autonomously reads the directories within the "plug-ins" directory found in the generated user directory.

Each plug-in is initialized based off of the "plug_in.bootloader" file found at the root of the plug-in directory

---

If you are looking to create your own plug-in it is recommended to import the GlobalAPI from the root of the package
...
def headless_mode(*__args,**__kwargs):
    ...
    active_logger.write_to_output(active_logger.format_output("info",0,"this is a test to ensure file sync'ed correctly"))
    Tests()
