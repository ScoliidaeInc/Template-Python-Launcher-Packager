...
class Tests:
    ...
    print(
        ...
        f"{api.plugins.path= }=={api.path.normalize(api.plugins.path)}",
        f"{api.plugins.path_exists()= }",
        f"{api.plugins.boot_loader= }=={api.path.normalize(api.plugins.boot_loader)}",
        f"{api.plugins.boot_loader_exists()= }",
